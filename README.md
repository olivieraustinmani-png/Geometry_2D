...
- Utils.h: permet d'afficher et convertir les textes.
...
* Lerp, Dot, Determinant: prennent en charge les operations avance a savoir:
   Produit scaler entre deux vecteur ( Dot)
   Determinant entre deux vecteur ( Dertaminant)
   Point intermediaireentre deux fonctions ( Lerp).
